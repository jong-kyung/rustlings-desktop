...
vi.mock("../composables/useLearningSession", async () => {
  ...
  return {
    ...
    useLearningSession: () => ({
      ...
      viewingSolution: ref(false),
      viewPath: ref("exercises/00_intro/intro1.rs"),
      viewSource: ref("fn main() {}"),
      viewSourceDigest: ref("digest"),
      viewReadme: ref("Lesson"),
      viewModelId: ref("learner:intro1"),
      activeRun: ref(undefined),
      hint: ref(undefined),
